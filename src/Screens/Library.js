...
<View style={{flexDirection:'row',height:hp(10),width:'100%',justifyContent:'center',top:hp(5)}}>

<LinearGradient colors={[this.Downloads?'transparent':'#FE7F14', this.Downloads?'transparent': '#B91A15']} 
style={{top:hp(0),width:wp(40),alignSelf:'center',
                borderRadius:10,height:hp(6)}}>
        <TouchableOpacity
        onPress={()=>{
            this.Downloads=false
        ...
        >
        <Text  style={{color:this.Downloads?'#FC6701':'white',top:hp(1.2),left:wp(0),alignSelf:'center'}}>
        All
                </Text>
        </TouchableOpacity>
        </LinearGradient>
        <LinearGradient colors={[!this.Downloads?'transparent':'#FE7F14', !this.Downloads?'transparent': '#B91A15']} style={{top:hp(0),width:wp(40),alignSelf:'center',
                borderRadius:10,height:hp(6)}}>
        <TouchableOpacity 
          onPress={()=>{
            this.Downloads=true
...
<View style={{height:hp(60),top:hp(6),paddingBottom:hp(5)}}>
